...
# define 'frames' variable that will be used below
frames = 0
...
net = imageNet(model="models/wheelchair_detector/resnet18.onnx", labels="data/handicapped_none/labels.txt", input_blob="input_0", output_blob="output_0")
...
while True:
    ...
    # send a ping to the door on detection
    if classID == 0:
        frames +=1
        if frames >=24:
             print("Open the door!")
